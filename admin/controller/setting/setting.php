...
/* #Google Captha */
		...
		if (isset($this->request->post['config_google_analytics'])) {
			...
			$this->data['config_google_analytics'] = $this->config->get('config_google_analytics');
				...
				if (isset($this->request->post['config_day0'])) {
			$this->data['config_day0'] = $this->request->post['config_day0'];
		} else {
			$this->data['config_day0'] = $this->config->get('config_day0');
		}

		if (isset($this->request->post['config_day1'])) {
			$this->data['config_day1'] = $this->request->post['config_day1'];
		} else {
			$this->data['config_day1'] = $this->config->get('config_day1');
		}

		if (isset($this->request->post['config_day2'])) {
			$this->data['config_day2'] = $this->request->post['config_day2'];
		} else {
			$this->data['config_day2'] = $this->config->get('config_day2');
		}

		if (isset($this->request->post['config_day3'])) {
			$this->data['config_day3'] = $this->request->post['config_day3'];
		} else {
			$this->data['config_day3'] = $this->config->get('config_day3');
		}

		if (isset($this->request->post['config_day4'])) {
			$this->data['config_day4'] = $this->request->post['config_day4'];
		} else {
			$this->data['config_day4'] = $this->config->get('config_day4');
		}

		if (isset($this->request->post['config_day5'])) {
			$this->data['config_day5'] = $this->request->post['config_day5'];
		} else {
			$this->data['config_day5'] = $this->config->get('config_day5');
		}

		if (isset($this->request->post['config_day6'])) {
			$this->data['config_day6'] = $this->request->post['config_day6'];
		} else {
			$this->data['config_day6'] = $this->config->get('config_day6');
		}

		if (isset($this->request->post['config_sms_text'])) {
			$this->data['config_sms_text'] = $this->request->post['config_sms_text'];
		} else {
			$this->data['config_sms_text'] = $this->config->get('config_sms_text');
		}
		
		if (isset($this->request->post['config_sms_text_off'])) {
			$this->data['config_sms_text_off'] = $this->request->post['config_sms_text_off'];
		} else {
			$this->data['config_sms_text_off'] = $this->config->get('config_sms_text_off');
		}
		
		if (isset($this->request->post['config_sms_sat_off'])) {
			$this->data['config_sms_sat_off'] = $this->request->post['config_sms_sat_off'];
		} else {
			$this->data['config_sms_sat_off'] = $this->config->get('config_sms_sat_off');
		}
		
		if (isset($this->request->post['config_day1_off'])) {
			$this->data['config_day1_off'] = $this->request->post['config_day1_off'];
		} else {
			$this->data['config_day1_off'] = $this->config->get('config_day1_off');
		}

		if (isset($this->request->post['config_day2_off'])) {
			$this->data['config_day2_off'] = $this->request->post['config_day2_off'];
		} else {
			$this->data['config_day2_off'] = $this->config->get('config_day2_off');
		}

		if (isset($this->request->post['config_day3_off'])) {
			$this->data['config_day3_off'] = $this->request->post['config_day3_off'];
		} else {
			$this->data['config_day3_off'] = $this->config->get('config_day3_off');
		}

		if (isset($this->request->post['config_day4_off'])) {
			$this->data['config_day4_off'] = $this->request->post['config_day4_off'];
		} else {
			$this->data['config_day4_off'] = $this->config->get('config_day4_off');
		}

		if (isset($this->request->post['config_day5_off'])) {
			$this->data['config_day5_off'] = $this->request->post['config_day5_off'];
		} else {
			$this->data['config_day5_off'] = $this->config->get('config_day5_off');
		}

		if (isset($this->request->post['config_day6_off'])) {
			$this->data['config_day6_off'] = $this->request->post['config_day6_off'];
		} else {
			$this->data['config_day6_off'] = $this->config->get('config_day6_off');
		}

		if (isset($this->request->post['config_day0_off'])) {
			$this->data['config_day0_off'] = $this->request->post['config_day0_off'];
		} else {
			$this->data['config_day0_off'] = $this->config->get('config_day0_off');
		}
