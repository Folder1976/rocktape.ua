        ...
        <div id="tab-option">
          ...
          <table class="form">
            <tr>
              <td>Понедельник</td>
              <td>
			    <input type="text" name="config_day1" value="<?php echo $config_day1; ?>"/>
				<input type="checkbox" name="config_day1_off" <?php if ($config_day1_off) { ?> checked="checked" <?php } ?>> Выходной
			  </td>
            </tr>
            <tr>
              <td>Вторник</td>
              <td>
			    <input type="text" name="config_day2" value="<?php echo $config_day2; ?>"/>
				<input type="checkbox" name="config_day2_off" <?php if ($config_day2_off) { ?> checked="checked" <?php } ?>> Выходной
			  </td>
            </tr>
            <tr>
              <td>Среда</td>
              <td>
			    <input type="text" name="config_day3" value="<?php echo $config_day3; ?>"/>
				<input type="checkbox" name="config_day3_off" <?php if ($config_day3_off) { ?> checked="checked" <?php } ?>> Выходной
			  </td>
            </tr>
            <tr>
              <td>Четверг</td>
              <td>
			    <input type="text" name="config_day4" value="<?php echo $config_day4; ?>"/>
				<input type="checkbox" name="config_day4_off" <?php if ($config_day4_off) { ?> checked="checked" <?php } ?>> Выходной
			  </td>
            </tr>
            <tr>
              <td>Пятница</td>
              <td>
			    <input type="text" name="config_day5" value="<?php echo $config_day5; ?>"/>
				<input type="checkbox" name="config_day5_off" <?php if ($config_day5_off) { ?> checked="checked" <?php } ?>> Выходной
			  </td>
            </tr>
            <tr>
              <td>Суббота</td>
              <td>
			    <input type="text" name="config_day6" value="<?php echo $config_day6; ?>"/>
				<input type="checkbox" name="config_day6_off" <?php if ($config_day6_off) { ?> checked="checked" <?php } ?>> Выходной
			  </td>
            </tr>
            <tr>
              <td>Воскресенье</td>
              <td>
			    <input type="text" name="config_day0" value="<?php echo $config_day0; ?>"/>
				<input type="checkbox" name="config_day0_off" <?php if ($config_day0_off) { ?> checked="checked" <?php } ?>> Выходной
			  </td>
            </tr>
            <tr>
              <td>Обычный текст</td>
              <td>
			    <input type="text" name="config_sms_text" value="<?php echo $config_sms_text; ?>"/>
			  </td>
            </tr>
            <tr>
              <td>Текст в нерабочее время</td>
              <td>
			    <input type="text" name="config_sms_text_off" value="<?php echo $config_sms_text_off; ?>"/>
			  </td>
            </tr>
            <tr>
              <td>Текст в субботу после окончания или в выходной</td>
              <td>
			    <input type="text" name="config_sms_sat_off" value="<?php echo $config_sms_sat_off; ?>"/>
			  </td>
            </tr>
          </table>   
