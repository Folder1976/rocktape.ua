  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="help"><a class="top"><?php echo $text_help; ?></a>
        <ul>
          <li><a href="https://www.opencart.com" target="_blank"><?php echo $text_opencart; ?></a></li>
          <li><a href="https://www.opencart.com/index.php?route=documentation/introduction" target="_blank"><?php echo $text_documentation; ?></a></li>
