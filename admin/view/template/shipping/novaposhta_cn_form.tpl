			...
			<div class="panel-body">
				<form class="form-horizontal">
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="panel panel-default">
								<div class="panel-heading clearfix" style="padding-top: 12px; padding-bottom: 5px;">
									<h3 class="panel-title" style="padding-top: 5px; display: inline;"><?php echo $text_recipient; ?></h3>
