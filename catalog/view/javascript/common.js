$(document).ready(function() {
	...
	$('.button-search').bind('click', function() {
		 if($('input[name=\'search\']').attr('class') == "seo-search"){

            var search = $('input[name=\'search\']').attr('value');
            if (search) {
                url = $('base').attr('href') + 'search/' + encodeURIComponent(search);
            }
	...
	$.ajax({
		...
		success: function(json) {
            ...
            if (json['error_stock']) {
                ...
                $('html, body').animate({ scrollTop: $("#notification").offset().top - 20 }, 'slow');
            }
