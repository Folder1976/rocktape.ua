<?php
	...
	$helper->addScript( 'catalog/view/javascript/common.js?'.$ver<?php
	$version = '002';
												...
												<ul class="nav navbar-nav">
													...
													<li class="parent dropdown deeper "><a href="https://rocktape.ua/rock-tape-producer" class="dropdown-toggle" data-toggle="dropdown">Продукция<b class="caret"></b></a>
														<ul class="dropdown-menu">
															...
															<li><a href="https://rocktape.ua/apparel" >Одежда</a>
																<!--li><a href="https://rocktape.ua/apparel-men">Мужская одежда (2)</a></li>
																<li><a href="https://rocktape.ua/apparel-women">Женская одежда (2)</a></li>
																<li><a href="https://rocktape.ua/accessories">Аксессуары (1)</a></li-->
															</li>
															<li><a href="https://rocktape.ua/other">Прочее</a></li>
														</ul>
													</li>
													...
													<li><a href="https://rocktape.ua/pavblog" title="Блог">Блог</a></li>
												</ul>
											</div>
																						</nav>
