...
<div id="content"><?php echo $content_top; ?>
	...
	<div class="checkout">
		<div id="checkout">
		<a id="promo" href="http://rocktapestore.com.ua/shopping-cart">Ввести промокод</a>
					...
					<?php }?>
						...
						<div class="checkout-product">
							<table>
								...
								<tfoot>
								    <tr>
								      <td colspan="6" id="button_checkout">
...
$('#checkout_form select[name=\'country_id\']').trigger('change');
	...
	$('#confirm').live('click', function() {
	   $("#confirm").fadeOut();
       $("#button_checkout").append('<a class="button" id="loading">Ожидайте...</a>');
		$.ajax({
