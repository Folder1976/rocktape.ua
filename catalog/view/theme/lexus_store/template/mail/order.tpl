      ...
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_order_id; ?></b> <?php echo $order_id; ?><br />
          ...
          <b><?php echo $text_payment_method; ?></b> <?php echo $payment_method; ?><br />
            <?php if ($payment_method == 'Наложенный платеж') { ?>
                <p style="color: red; max-width: 250px;">Внимание! В стоимость заказа не включены расходы на услуги Новой почты за доставку товара и денежный перевод.</p>
            <?php } ?>
