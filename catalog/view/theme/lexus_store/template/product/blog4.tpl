...
<section class="page-product-blog__section seminar-short-info">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h1 class="seminar-short-info__title">FMT screen & movability</h1>
           ...
           <div class="col-md-4">
               <img src="/image/data/education/screen-movability.jpg" alt="screen-movability" class="seminar-short-info__img">
           </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div id="accordion-seminar" class="col-md-4">
                <div class="accordion">
                    <div class="accordion__title text-center" data-toggle="collapse" data-target="#accordion-1"><?php echo $name2; ?></div>
                ...
                <div class="accordion">
                    <div class="accordion__title text-center collapsed" data-toggle="collapse" data-target="#accordion-2"><?php echo $name3; ?></div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="accordion">
                    <div class="accordion__title text-center collapsed" data-toggle="collapse" data-target="#accordion-basic"><?php echo $name4; ?></div>
            ...
            <div class="col-md-6">
                <div class="accordion">
                    <div class="accordion__title text-center collapsed" data-toggle="collapse" data-target="#accordion-performance"><?php echo $name5; ?></div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="accordion">
                    <div class="accordion__title text-center collapsed" data-toggle="collapse" data-target="#accordion-price"><?php echo $name6; ?></div>
            ...
            <div class="col-md-6">
                <div class="accordion">
                    <div class="accordion__title text-center collapsed" data-toggle="collapse" data-target="#accordion-included"><?php echo $name7; ?></div>
                    <div id="accordion-included" class="accordion__content collapse"><?php echo $description7; ?></div>
                </div>
            </div>
        </div>
    </div>
...
<?php
$video_src = array (
    'https://www.youtube.com/embed/skN_LNlu7Vg',
); ?>
