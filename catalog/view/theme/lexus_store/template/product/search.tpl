    		...
    		<div class="col-lg-6 col-md-6 col-sm-6 sleft">
				<div class="row">
					...
					<div class="col-lg-10 col-md-10 col-sm-10">
						<?php if ($search) { ?>
						<input type="text" name="search" value="<?php echo $search; ?>" class="input-text form-control" data="<?php echo $seo_search ? $seo_search : 'input-search'; ?>" />
						<?php } else { ?>
						<input type="text" name="search" value="<?php echo $search; ?>"  data="<?php echo $seo_search ? $seo_search : 'input-search'; ?>" onclick="this.value = '';" onkeydown="this.style.color = '000000'" style="color: #999;"  class="input-text form-control"/>
						<?php } ?>
					</div>
				</div>				
    		</div>
...
if($('#content input[name=\'search\']').attr('data') == "seo-search"){
