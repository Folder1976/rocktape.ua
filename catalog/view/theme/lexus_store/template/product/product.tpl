...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
      ...
      <div class="col-lg-7 col-sm-6 col-xs-12">
          ...
          <div class="review">
            <div><img src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');$('html, body').animate({ scrollTop: $('#tab-review').offset().top - 40 }, 'slow');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');$('html, body').animate({ scrollTop: $('#review-title').offset().top - 40 }, 'slow');"><?php echo $text_write; ?></a></div>
          </div>
        <?php } ?>
        ...
        <div class="product-extra">
          <div class="quantity-adder">
            <div class="quantity-adder__title"><?php echo $text_qty; ?></div>
            <div class="quantity-adder__inner">
