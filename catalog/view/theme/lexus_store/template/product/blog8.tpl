...
<section class="page-product-blog__section seminar-short-info">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h1 class="seminar-short-info__title">Rocktape Beauty</h1>
           ...
           <div class="col-md-4">
               <img src="/image/data/education/special-rocktape-beauty_img.jpg" alt="Rocktape Beauty" class="seminar-short-info__img">
           </div>
        </div>
    </div>
</section>
...
<?php
$video_src = array (
    'https://www.youtube.com/embed/t4d8TTD4JAI',
); ?>
