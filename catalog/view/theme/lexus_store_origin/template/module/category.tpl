<div class="box category highlights">
    ...
    <div class="box-content">
        <ul id="accordion1" class="box-category list">
            <?php
        $k=0;
        ...
        $active="";
          ...
          $class = "haschild";
            ...
            <li class="<?php echo $class; ?>">
                ...
                <ul id="collapseOne<?php echo $k ;?>" class="panel-collapse <?php echo ($category['category_id'] == $category_id)?'in':'collapse'; ?>" style="<?php echo ($category['category_id'] == $category_id)?'height:auto;':'height:0;'; ?>">
