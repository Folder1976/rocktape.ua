...
class ModelAccountOrder extends Model {
	...
	public function getOrderProducts($order_id) {
        ...
        $sql = "SELECT p.*,pr.manufacturer_id, cd.name as cname, m.name as mname FROM " . DB_PREFIX . "order_product as p
        LEFT JOIN ".DB_PREFIX."product as pr ON pr.product_id = p.product_id
        LEFT JOIN ".DB_PREFIX."product_to_category as pc ON pc.product_id = p.product_id
        LEFT JOIN ".DB_PREFIX."category_description as cd ON cd.category_id = pc.category_id
        LEFT JOIN ".DB_PREFIX."manufacturer as m ON m.manufacturer_id = pr.manufacturer_id
         WHERE p.order_id = '" . (int)$order_id . "' AND cd.language_id = '".(int)$this->config->get('config_language_id') ."'";
