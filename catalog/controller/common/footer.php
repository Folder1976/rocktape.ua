...
class ControllerCommonFooter extends Controller {
	protected function index() {
		...
		$this->data['text_about_rocktape'] = $this->language->get('text_about_rocktape');
		...
		$this->data['compare_products'] = $this->url->link('product/compare', '', 'SSL');	
		$this->data['about_rocktape'] = HTTP_SERVER . "about-rocktape";		
